...
mh1 = mahasiswa("jessica", 104, "aa", 15000)
mh2 = mahasiswa("rahajeng", 84, "bb", 13000)
mh3 = mahasiswa("cinta", 124, "cc", 5000)
mh4 = mahasiswa("milo", 544, "dd", 12000)
mh5 = mahasiswa("miko", 4, "ee", 2500)
