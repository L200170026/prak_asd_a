...
#No2
def cariDaftarSakuTerkecil(kumpulan):
...
#No4
def cariUangSakuKurang(kumpulan):
    b = []  
    for i in kumpulan:
...
misalkan : apabila terdapat elemen array berjumlah 100 maka memiliki maksimal 7 kali tebakan
